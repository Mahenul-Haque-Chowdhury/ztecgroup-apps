...
export const metadata: Metadata = buildSiteMetadata("hospitality", {}, process.env.NEXT_PUBLIC_SITE_URL);
...
export default function RootLayout({
  ...
  const websiteSchema = buildWebSiteSchema("hospitality", process.env.NEXT_PUBLIC_SITE_URL);
  const serviceSchema = buildServiceSchema("hospitality", process.env.NEXT_PUBLIC_SITE_URL);
