...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL ?? "https://hospitality.ztecgroup.au"),
  applicationName: "ZTEC Hospitality",
  title: {
    default: "ZTEC Hospitality - STRA Management Consultation",
    template: "%s | ZTEC Hospitality",
  },
  description:
