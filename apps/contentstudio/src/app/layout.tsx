...
export const metadata: Metadata = buildSiteMetadata("contentstudio", {}, process.env.NEXT_PUBLIC_SITE_URL);
...
export default function RootLayout({
  ...
  const websiteSchema = buildWebSiteSchema("contentstudio", process.env.NEXT_PUBLIC_SITE_URL);
  const serviceSchema = buildServiceSchema("contentstudio", process.env.NEXT_PUBLIC_SITE_URL);
