...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL ?? "https://contentstudio.ztecgroup.au"),
  applicationName: "ZTEC Content Studio",
  title: {
    default: "ZTEC Content Studio - Video & Motion Content Studio",
    template: "%s | ZTEC Content Studio",
  },
  description:
