        ...
        <div className="cinematic-panel relative overflow-hidden rounded-t-3xl rounded-b-none p-6 sm:p-8 md:p-10 lg:p-14">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/55 max-w-sm mb-8 leading-relaxed">
              Standalone post-production, motion content, and edit delivery focused on one creative service line from ZTEC Group.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/" className="text-white/50 hover:text-white transition-colors">Video & Motion Content Studio</Link></li>
