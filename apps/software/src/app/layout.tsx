...
export const metadata: Metadata = buildSiteMetadata("software", {}, process.env.NEXT_PUBLIC_SITE_URL);
...
export default function RootLayout({
  ...
  const websiteSchema = buildWebSiteSchema("software", process.env.NEXT_PUBLIC_SITE_URL);
  const serviceSchema = buildServiceSchema("software", process.env.NEXT_PUBLIC_SITE_URL);
